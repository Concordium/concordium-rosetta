...
pub struct AccountBalanceRequest {
    ...
    pub account_identifier: Box<crate::models::AccountIdentifier>,
    #[serde(rename = "block_identifier", skip_serializing_if = "Option::is_none")]
    pub block_identifier: Option<Box<crate::models::PartialBlockIdentifier>>,
...
impl AccountBalanceRequest {
    ...
    pub fn new(network_identifier: crate::models::NetworkIdentifier, account_identifier: crate::models::AccountIdentifier) -> AccountBalanceRequest {
