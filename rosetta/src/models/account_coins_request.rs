...
impl AccountCoinsRequest {
    ...
    pub fn new(network_identifier: crate::models::NetworkIdentifier, account_identifier: crate::models::AccountIdentifier, include_mempool: bool) -> AccountCoinsRequest {
        AccountCoinsRequest {
