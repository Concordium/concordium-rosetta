...
impl Block {
    ...
    pub fn new(block_identifier: crate::models::BlockIdentifier, parent_block_identifier: crate::models::BlockIdentifier, timestamp: i64, transactions: Vec<crate::models::Transaction>) -> Block {
        Block {
