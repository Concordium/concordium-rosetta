...
pub struct BlockEvent {
    ...
    #[serde(rename = "type")]
    pub _type: crate::models::BlockEventType,
}
...
impl BlockEvent {
    ...
    pub fn new(sequence: i64, block_identifier: crate::models::BlockIdentifier, _type: crate::models::BlockEventType) -> BlockEvent {
        BlockEvent {
            sequence,
