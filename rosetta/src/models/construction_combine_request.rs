...
impl ConstructionCombineRequest {
    ...
    pub fn new(network_identifier: crate::models::NetworkIdentifier, unsigned_transaction: String, signatures: Vec<crate::models::Signature>) -> ConstructionCombineRequest {
