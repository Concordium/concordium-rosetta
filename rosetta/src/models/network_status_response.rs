...
impl NetworkStatusResponse {
    ...
    pub fn new(current_block_identifier: crate::models::BlockIdentifier, current_block_timestamp: i64, genesis_block_identifier: crate::models::BlockIdentifier, peers: Vec<crate::models::Peer>) -> NetworkStatusResponse {
        NetworkStatusResponse {
