...
impl Signature {
    ...
    pub fn new(signing_payload: crate::models::SigningPayload, public_key: crate::models::PublicKey, signature_type: crate::models::SignatureType, hex_bytes: String) -> Signature {
        Signature {
